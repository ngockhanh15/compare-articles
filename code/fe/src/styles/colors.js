...
// Sử dụng file này để import màu sắc trong JavaScript/React components
...
// Shorthand colors for quick access
export const theme = {
...
export const gradients = {
  ...
  ocean: `linear-gradient(135deg, ${colors.primary[400]} 0%, ${colors.accent[500]} 100%)`,
};
